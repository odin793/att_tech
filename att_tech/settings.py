# Django settings for att_tech project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': rel('att_tech.db'),                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = rel('static_root') # not used in development
...
SECRET_KEY = '^f2_+%q-xvao0h8z^01-%z_25)m1eb&amp;6)w1uf*cul3pivkvrti'
...
ROOT_URLCONF = 'att_tech.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'att_tech.wsgi.application'

TEMPLATE_DIRS = (
    rel('att_tech_app/templates'),
    rel('att_tech_app/templatetags'),

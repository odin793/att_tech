...
urlpatterns = patterns('',
    ...
    url(r'^about_tech/(constituent_docs)/$', page_with_docs_view, name="constituent_docs"),
    url(r'^about_tech/employees/$', employees_page, name="employees_page"),
    url(r'^about_tech/masters/$', masters_page, name="masters_page"),
    url(r'^matriculants/profs_and_specs/$', profs_and_specs_page, name="profs_and_specs"),
    url(r'^matriculants/(docs_samples)/$', page_with_docs_view, name="docs_samples"),
    url(r'^matriculants/(acceptance)/$', page_with_docs_view, name="acceptance"),
    url(r'^matriculants/(tuition_by_correspondence)/$', basic_page_view, name="tuition_by_correspondence"),
    url(r'^matriculants/(courses)/$', basic_page_view, name="courses"),
    url(r'^matriculants/(acceptance_rules)/$', basic_page_view, name="acceptance_rules"),

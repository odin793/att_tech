...
urlpatterns = patterns('',
    ...
    url(r'^about_tech/(normative_docs)/$', page_with_docs_view,
        name="normative_docs"),
    url(r'^about_tech/(educational_standards)/$', page_with_docs_view,
        name="educational_standards"),
    url(r'^about_tech/(material_logistics)/$', page_with_docs_view,
        name="material_logistics"),
    url(r'^about_tech/(scholarships)/$', page_with_docs_view,
        name="scholarships"),
    url(r'^about_tech/(paid_services)/$', page_with_docs_view,
        name="paid_services"),
    url(r'^about_tech/(finance)/$', page_with_docs_view,
        name="finance"),
